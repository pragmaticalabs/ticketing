...
public interface BookingStore {
    ...
    @Query("""
           INSERT INTO reservations (id, seat_id, event_id, customer_id, state, expires_at, created_at)
    ...
    @Query("""
           UPDATE reservations SET state = 'confirmed', expires_at = NULL
    ...
    @Query("""
           INSERT INTO bookings (id, reservation_id, seat_id, event_id, customer_id, status, ticket_id)
    ...
    @Query("""
           SELECT state, (expires_at < now()) AS expired,
