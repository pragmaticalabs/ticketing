...
/// `[log.availability.project-seat-released]` in resources.toml. The interceptor carries its own
...
@ResourceQualifier(type = LoggingMethodInterceptor.class, config = "log.availability.project-seat-released")
@Retention(RUNTIME)
@Target(METHOD)
